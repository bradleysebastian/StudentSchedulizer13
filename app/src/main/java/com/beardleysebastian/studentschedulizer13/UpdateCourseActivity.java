...
public class UpdateCourseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_course_activity);
        ...
        courseName = findViewById(R.id.upd_course_name_input);

        startDatePickBtn = findViewById(R.id.upd_course_start_date_btn);
        startDatePickBtn.setOnClickListener(this);
        startDateETxt = findViewById(R.id.upd_course_start_date_txt);

        endDatePickBtn = findViewById(R.id.upd_course_end_date_btn);
        endDatePickBtn.setOnClickListener(this);
        endDateETxt = findViewById(R.id.upd_course_end_date_txt);

        status = findViewById(R.id.upd_course_status_txt);
        mentorName = findViewById(R.id.upd_course_mentor_name_txt);
        mentorEmail = findViewById(R.id.upd_course_mentor_email_txt);
        mentorPhone = findViewById(R.id.upd_course_mentor_phone_txt);

        courseName.setText(CatalogDatabase.getInstance().getCourse(courseID).getCourseName());
        startDateETxt.setText(CatalogDatabase.getInstance().getCourse(courseID).getTargetStart());
        endDateETxt.setText(CatalogDatabase.getInstance().getCourse(courseID).getTargetEnd());
        status.setText(CatalogDatabase.getInstance().getCourse(courseID).getCourseStatus());
        mentorName.setText(CatalogDatabase.getInstance().getCourse(courseID).getCourseMentorName());
        mentorEmail.setText(CatalogDatabase.getInstance().getCourse(courseID).getCourseMentorEmail());
        mentorPhone.setText(CatalogDatabase.getInstance().getCourse(courseID).getCourseMentorPhone());
    }
...
//                    endDateETxt.setText(year + "-" + strMonth + "-" + strDay);
    ...
    public void saveUpdCourse(View view) {
...
//            Toast.makeText(this, "Start Date after End Date",Toast.LENGTH_LONG).show();
            ...
            CatalogDatabase.getInstance().updateCourse(
                    this,
                    termID,
                    courseID,
